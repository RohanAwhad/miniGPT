...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        logger.infor("number of parameters: %e", sum(p.numel() for p in self.parameters()))
    ...
    def configure_optimizers(self, train_config):
        ...
        # separate out all parameter to those that will and won't experience regularizing weight decay
        decay = set()
        no_decay = set()
        ...
        optimizer = torch.optim.AdamW(optim_groups, lr=train_config.learning_rate, beats=train_config.betas)
        return optimizer
